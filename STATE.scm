...
;; STATE.scm - Project state tracking for asdf-fulcio-plugin
;; Media-Type: application/vnd.state+scm

(define-state asdf-fulcio-plugin
  (metadata
    (version "0.1.0")
    (schema-version "1.0.0")
    (created "2026-01-30")
    (updated "2026-01-30")
    (project "asdf-fulcio-plugin")
    (repo "hyperpolymath/asdf-fulcio-plugin"))

  (project-context
    (name "asdf-fulcio-plugin")
