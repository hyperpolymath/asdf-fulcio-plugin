...
:url-repo: https://github.com/hyperpolymath/asdf-fulcio-plugin
...
image:https://img.shields.io/github/license/hyperpolymath/asdf-fulcio-plugin?style=flat-square[License,link=LICENSE]
image:https://img.shields.io/github/v/release/hyperpolymath/asdf-fulcio-plugin?style=flat-square[Release,link={url-repo}/releases]
image:https://img.shields.io/github/actions/workflow/status/hyperpolymath/asdf-fulcio-plugin/ci.yml?branch=main&style=flat-square[Build Status,link={url-repo}/actions]
image:https://img.shields.io/badge/asdf-plugin-blue?style=flat-square[asdf Plugin,link={url-asdf}]

[.lead]
An {url-asdf}[asdf] plugin to install and manage {url-tool}[Fulcio] versions.
...
Fulcio is an upstream tool managed by this plugin. Refer to the official
...
|**Version Switching**
|Switch between Fulcio versions per project

|**Project Isolation**
|Pin Fulcio per repository via `.tool-versions`

|**Reproducible Builds**
|Align CI/CD and developer environments to the same Fulcio version
...
=== Installing Fulcio Versions

[source,bash]
----
asdf list all fulcio
asdf install fulcio latest
asdf install fulcio 0.1.0
----
...
[source,bash]
----
asdf global fulcio 0.1.0
asdf local fulcio 0.1.0
asdf current fulcio
fulcio --version
----
...
* Ensure `fulcio` is on PATH after installation.
* Verify the installed version with `fulcio --version`.
